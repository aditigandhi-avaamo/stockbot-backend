...
if (ticket.status === "Closed") {
  return {
    success: false,
    avm_instruction: "Ticket is closed. Ask the user whether they want to reopen it first before adding an update."
  };
}
...
return {
  success: true,
  avm_instruction: "Ticket updated successfully. Tell the user: Your comment has been added to ticket " + context.ticket_id + ". The IT team will be notified."
};